...
async function main(components: Components) {
	...
	// TODO remove
	let imapAccount = new ImapAccount("imapserver", 993, "johannes").setPassword("Wsw6r6dzEH7Y9mDJ")
	let mailboxStates = [new MailboxState("\TestNew", 1, 2130230, 0, new Map<number, IdTuple>()), new MailboxState("\Test", 1, 2323, 0, new Map<number, IdTuple>())]
