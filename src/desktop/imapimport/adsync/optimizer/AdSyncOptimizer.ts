...
export abstract class AdSyncOptimizer {
	...
	protected getCurrentTimeStampInterval(): TimeStampInterval {
		let fromTimeStamp = typeof this.optimizerUpdateTimeStampHistory.at(-1) !== 'undefined' ? this.optimizerUpdateTimeStampHistory.at(-1)! : 0
		let toTimeStamp = Date.now()
		return {fromTimeStamp, toTimeStamp}
	}

	protected getLastTimeStampInterval(): TimeStampInterval {
		let fromTimeStamp = typeof this.optimizerUpdateTimeStampHistory.at(-2) !== 'undefined' ? this.optimizerUpdateTimeStampHistory.at(-2)! : 0
		let toTimeStamp = typeof this.optimizerUpdateTimeStampHistory.at(-1) !== 'undefined' ? this.optimizerUpdateTimeStampHistory.at(-1)! : Date.now()
		return {fromTimeStamp, toTimeStamp}
	}
}
